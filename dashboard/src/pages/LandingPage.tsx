    ...
    <div style={{ paddingBottom: '4rem' }}>
      ...
      <section className="container" style={{ paddingTop: '8rem', paddingBottom: '6rem', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
          ...
          <Link to="/deliberation" className="btn-secondary" style={{ padding: '1rem 2rem', fontSize: '1.1rem' }}>
            Watch a Case
          </Link>
        </div>
      </section>
      ...
      <section className="container" style={{ padding: '8rem 0', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(255, 59, 59, 0.1)', color: 'var(--primary)', padding: '0.5rem 1rem', borderRadius: '999px', marginBottom: '2rem' }}>
          <Shield size={16} /> <span style={{ fontSize: '0.85rem', fontWeight: 600, letterSpacing: '0.05em' }}>BUILT TO BE TRUSTED</span>
        </div>
        <h2 style={{ fontSize: '3rem', marginBottom: '2rem', maxWidth: '800px', margin: '0 auto 2rem', letterSpacing: '-0.02em' }}>
        ...
        <Link to="/architecture" className="btn-secondary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2rem', fontSize: '1.1rem' }}>
