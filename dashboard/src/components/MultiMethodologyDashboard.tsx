...
const AGENTS: AgentProfile[] = [
  {
    ...
    role: 'Valuation Agent A',
    icon: <Search size={18} />,
    color: '#6366f1',
    bgColor: 'rgba(99, 102, 241, 0.08)',
    methodology: 'Comparable Sales Analysis',
    description: 'Analyzes recent sales of similar properties in the same market. Adjusts for differences in size, condition, location, and amenities.',
  },
  {
    id: 'income-specialist',
    name: 'Income Specialist',
    role: 'Valuation Agent B',
    icon: <BarChart3 size={18} />,
    color: '#8b5cf6',
    bgColor: 'rgba(139, 92, 246, 0.08)',
    methodology: 'Discounted Cash Flow (DCF)',
    description: 'Projects future rental income and applies a discount rate to calculate present value. Considers vacancy rates, operating expenses, and market trends.',
  },
  {
    ...
    description: 'Reviews data quality, source reliability, and methodology rigor. Flags inconsistencies, outliers, and potential data manipulation.',
  },
  {
    id: 'trend-analyst',
    name: 'Trend Analyst',
    ...
    description: 'Evaluates macroeconomic conditions, interest rates, local market dynamics, and seasonal patterns. Assesses whether trends support or contradict valuations.',
  },
  {
    id: 'case-researcher',
    ...
    description: 'Searches for historical precedents and comparable disputes. Applies lessons from past cases to inform current valuation decisions.',
  },
];
