...
const scenes = [
  // Scene 1: Disagreement
  {
    bg: bgProperty,
    elements: [
      { id: 'owner', src: charOwner, initial: { x: -200, opacity: 0 }, animate: { x: 0, opacity: 1 }, style: { bottom: '0', left: '10%', height: '65%' } },
      { id: 'investor', src: charInvestor, initial: { x: 200, opacity: 0 }, animate: { x: 0, opacity: 1 }, style: { bottom: '0', right: '10%', height: '65%' } }
    ],
    bubbles: [
      { speaker: 'Asset Owner', text: 'This commercial building is easily worth $2.5 Million!', style: { top: '15%', left: '15%' }, delay: 0.5 },
      { speaker: 'Investor', text: 'No way, the market data says it\'s only worth $1.8 Million. We are at a deadlock.', style: { top: '15%', right: '15%' }, delay: 1.5 }
    ]
  },
  // Scene 2: Confusion
  {
    bg: bgProperty,
    elements: [
      { id: 'observer', src: charObserver, initial: { y: 200, opacity: 0 }, animate: { y: 0, opacity: 1 }, style: { bottom: '0', left: '35%', height: '70%' } }
    ],
    bubbles: [
      { speaker: 'Observer', text: 'Oh no... a major financial dispute. This is going to take months in court and cost thousands in legal fees. How do we solve this fairly without a central authority?', style: { top: '15%', left: '10%' }, delay: 0.5 }
    ]
  },
  // Scene 3: Enter the Hero
  {
    ...
    bubbles: [
      { speaker: 'Verdict', text: 'Fear not! I am Verdict. I can resolve this dispute instantly, fairly, and permanently using AI and the blockchain!', style: { top: '10%', left: '35%' }, delay: 0.8 }
    ]
  },
  // Scene 4: ZK
  {
    ...
    elements: [
      ...
      { id: 'owner', src: charOwner, initial: { opacity: 0 }, animate: { opacity: 1 }, style: { bottom: '0', right: '30%', height: '60%' } },
      { id: 'investor', src: charInvestor, initial: { opacity: 0 }, animate: { opacity: 1 }, style: { bottom: '0', right: '10%', height: '60%' } }
    ],
    bubbles: [
      { speaker: 'Verdict', text: 'First, upload your data. Don\'t worry about privacy - we use Zero-Knowledge (ZK) technology. This lets you prove your financial numbers are real without actually showing me your private bank statements!', style: { top: '10%', left: '20%', maxWidth: '400px' }, delay: 0.5, learnMore: 'ZK Proofs' }
    ]
  },
  // Scene 5: X402
  {
    ...
    bubbles: [
      { speaker: 'Verdict', text: 'To ensure nobody unauthorized sneaks into this dispute, we issue an X402 Token. Think of it as a VIP digital ticket. It ensures only verified parties have access to this specific case.', style: { top: '15%', left: '35%', maxWidth: '400px' }, delay: 0.2, learnMore: 'X402 Authentication' }
    ]
  },
  // Scene 6: HMAC
  {
    ...
    bubbles: [
      { speaker: 'Verdict', text: 'When you send the data, we stamp it with an HMAC. Think of it as an unbreakable digital wax seal. If a hacker tries to tamper with the data while it\'s traveling, the seal breaks and we reject it!', style: { top: '15%', left: '35%', maxWidth: '400px' }, delay: 0.2, learnMore: 'HMAC Security' }
    ]
  },
  // Scene 7: Summoning Agents
  {
    ...
    elements: [
      ...
      { id: 'bot2', src: propAgentBot, initial: { scale: 0 }, animate: { scale: 1, x: [0, -30, 20, 0], y: [0, 25, -15, 0] }, style: { bottom: '60%', right: '25%', height: '12%' }, transition: { delay: 0.7, x: { repeat: Infinity, duration: 4.5 }, y: { repeat: Infinity, duration: 3.5 } } },
      { id: 'bot3', src: propAgentBot, initial: { scale: 0 }, animate: { scale: 1, x: [0, 25, -25, 0], y: [0, 15, -20, 0] }, style: { bottom: '30%', right: '15%', height: '12%' }, transition: { delay: 0.9, x: { repeat: Infinity, duration: 3.8 }, y: { repeat: Infinity, duration: 4 } } },
      { id: 'bot4', src: propAgentBot, initial: { scale: 0 }, animate: { scale: 1, x: [0, -40, 30, 0], y: [0, -20, 25, 0] }, style: { bottom: '50%', right: '10%', height: '12%' }, transition: { delay: 1.1, x: { repeat: Infinity, duration: 5 }, y: { repeat: Infinity, duration: 4.2 } } },
      { id: 'bot5', src: propAgentBot, initial: { scale: 0 }, animate: { scale: 1, x: [0, 30, -30, 0], y: [0, 30, -10, 0] }, style: { bottom: '70%', right: '35%', height: '12%' }, transition: { delay: 1.3, x: { repeat: Infinity, duration: 4.2 }, y: { repeat: Infinity, duration: 4.8 } } }
    ],
    bubbles: [
  ...
  // Scene 8: Investigation
  {
    bg: bgVerdictHq,
    elements: [
      { id: 'observer', src: charObserver, initial: { opacity: 0, x: -50 }, animate: { opacity: 1, x: 0 }, style: { bottom: '0', left: '5%', height: '65%' } },
      { id: 'hero', src: charVerdictHero, initial: { opacity: 1 }, animate: { opacity: 1 }, style: { bottom: '0', right: '10%', height: '80%' } }
    ],
    bubbles: [
      { speaker: 'Observer', text: 'Wait, what if one of the AI agents makes a mistake or is biased?', style: { top: '10%', left: '10%' }, delay: 0.5 },
      { speaker: 'Verdict', text: 'Great question! That\'s why they don\'t work alone.', style: { top: '10%', right: '15%' }, delay: 1.5 }
    ]
  },
  // Scene 9: Consensus
  {
    ...
    elements: [
      { id: 'hero', src: charVerdictHero, initial: { opacity: 1 }, animate: { opacity: 1 }, style: { bottom: '0', left: '5%', height: '80%' } },
      { id: 'bot1', src: propAgentBot, initial: { opacity: 1 }, animate: { y: [0, -10, 10, 0] }, style: { top: '25%', right: '30%', height: '12%' }, transition: { repeat: Infinity, duration: 3 } },
      { id: 'bot2', src: propAgentBot, initial: { opacity: 1 }, animate: { y: [0, -10, 10, 0] }, style: { bottom: '30%', right: '40%', height: '12%' }, transition: { repeat: Infinity, duration: 3.5, delay: 0.5 } },
      { id: 'bot3', src: propAgentBot, initial: { opacity: 1 }, animate: { y: [0, -10, 10, 0] }, style: { bottom: '40%', right: '15%', height: '12%' }, transition: { repeat: Infinity, duration: 4, delay: 1 } }
    ],
    bubbles: [
      { speaker: 'Verdict', text: 'The AI agents cross-check each other\'s work. Agents with a history of being highly accurate have their votes weighted heavier. We call this Trust-Weighted Consensus. It guarantees mathematical fairness.', style: { top: '5%', left: '25%', maxWidth: '400px' }, delay: 0.2 }
    ]
  },
  // Scene 10: Resolution
  {
    ...
    bubbles: [
      ...
      { speaker: 'Asset Owner', text: 'That makes total sense based on the verified data. I accept!', style: { top: '25%', left: '5%', maxWidth: '250px' }, delay: 2 },
      { speaker: 'Investor', text: 'Thank you for this awesome work, Verdict! This saved us months of legal battles.', style: { top: '25%', right: '5%', maxWidth: '250px' }, delay: 3 }
    ]
  },
  // Scene 11: Casper Blockchain
  {
    ...
    bubbles: [
      { speaker: 'Verdict', text: 'Finally, I take this verdict and permanently lock it onto the Casper Blockchain. Once it\'s on Casper, it can never be tampered with, deleted, or altered by anyone. Total transparency!', style: { top: '10%', left: '30%', maxWidth: '400px' }, delay: 0.5, learnMore: 'Casper Finality' }
    ]
  },
  // Scene 12: Conclusion
  {
    bg: bgProperty,
    elements: [
      { id: 'observer', src: charObserver, initial: { opacity: 0 }, animate: { opacity: 1 }, style: { bottom: '0', left: '5%', height: '70%' } },
      { id: 'hero', src: charVerdictHero, initial: { opacity: 0 }, animate: { opacity: 1 }, style: { bottom: '0', right: '5%', height: '80%' } }
    ],
    bubbles: [
      { speaker: 'Observer', text: 'So you securely gathered data, hid the private parts, proved it wasn\'t tampered with, resolved it using an AI swarm, and locked it on the blockchain?', style: { top: '10%', left: '10%', maxWidth: '350px' }, delay: 0.5 },
      { speaker: 'Verdict', text: 'Exactly. Welcome to the future of Real World Asset management.', style: { top: '15%', right: '10%', maxWidth: '350px' }, delay: 2.5 }
    ]
  }
];
